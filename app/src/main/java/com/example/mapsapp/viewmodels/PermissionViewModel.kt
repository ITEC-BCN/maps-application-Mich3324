...
import androidx.compose.runtime.State //Funciona com el LiveData, però sense necessitat de crear un observer a la UI


//administra l’estat i comunica el resultat a la UI.
